...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF6B60CD);
  late Color secondary = const Color(0xFF39D2C0);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF6B60CD);
  late Color primaryBackground = const Color(0xFFF1F6F9);
  late Color secondaryBackground = const Color(0xFFA8A4CE);
  late Color accent1 = const Color(0xFFA8A4CE);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondaryText = const Color(0xFF6B60CD);
  late Color primaryBackground = const Color(0xFF090918);
  late Color secondaryBackground = const Color(0xFFA8A4CE);
  late Color accent1 = const Color(0xFFA8A4CE);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
